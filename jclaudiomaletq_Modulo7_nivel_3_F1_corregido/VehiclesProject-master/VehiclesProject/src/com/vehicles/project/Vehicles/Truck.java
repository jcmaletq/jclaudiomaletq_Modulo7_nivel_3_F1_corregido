...
// contructores
	public Truck(plate Plate, String brand, String color, String person_id) {
		super(Plate, brand, color, person_id);
	}
	public Truck(String tipo) {
		super(tipo);
	}
// metodos	
	public static void crea_Truck() {
			Truck coche = new Truck ("Camion");
	...
	public static int f_crea_Truck() {
	...
	public void addConductor(Person pe)  {
		...
		if (drive_license.val_Type_dl(con.getType_dl_c(),"TRUCK"))
		{		this.Conductores.add(con);}
	}
	@Override
	public String toString() {
		return "This Truck has "+ " \n" 
